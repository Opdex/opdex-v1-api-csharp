...
namespace Opdex.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "setInterfluxCustodianEvent")]
    public partial class SetInterfluxCustodianEvent : IEquatable<SetInterfluxCustodianEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetInterfluxCustodianEvent" /> class.
        /// </summary>
        ...
        public SetInterfluxCustodianEvent(string from = default(string), string to = default(string), TransactionEventType eventType = default(TransactionEventType), string contract = default(string), int sortOrder = default(int))
        {
            this.From = from;
            this.To = to;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SetInterfluxCustodianEvent {\n");
        ...
        {
            return this.Equals(input as SetInterfluxCustodianEvent);
        }

        /// <summary>
        /// Returns true if SetInterfluxCustodianEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of SetInterfluxCustodianEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetInterfluxCustodianEvent input)
        {
            if (input == null)
            {
                return false;
