...
namespace Opdex.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "swapAmountInQuoteResponse")]
    public partial class SwapAmountInQuoteResponse : IEquatable<SwapAmountInQuoteResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SwapAmountInQuoteResponse" /> class.
        /// </summary>
        /// <param name="amountIn">Decimal value with uncapped precision and size.</param>
        public SwapAmountInQuoteResponse(string amountIn = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SwapAmountInQuoteResponse {\n");
        ...
        {
            return this.Equals(input as SwapAmountInQuoteResponse);
        }

        /// <summary>
        /// Returns true if SwapAmountInQuoteResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SwapAmountInQuoteResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwapAmountInQuoteResponse input)
        {
            if (input == null)
            {
                return false;
