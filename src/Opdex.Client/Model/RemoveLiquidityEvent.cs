...
{
    /// <summary>
    /// Indicates liquidity was removed from a pool
    /// </summary>
    [DataContract(Name = "removeLiquidityEvent")]
    public partial class RemoveLiquidityEvent : IEquatable<RemoveLiquidityEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveLiquidityEvent" /> class.
        /// </summary>
        ...
        public RemoveLiquidityEvent(string amountCrs = default(string), string amountSrc = default(string), string amountLpt = default(string), string tokenSrc = default(string), string tokenLp = default(string), string tokenLpTotalSupply = default(string), TransactionEventType eventType = default(TransactionEventType), string contract = default(string), int sortOrder = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RemoveLiquidityEvent {\n");
        ...
        {
            return this.Equals(input as RemoveLiquidityEvent);
        }

        /// <summary>
        /// Returns true if RemoveLiquidityEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoveLiquidityEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoveLiquidityEvent input)
        {
            if (input == null)
            {
                return false;
