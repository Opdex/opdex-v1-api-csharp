...
namespace Opdex.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "quoteProposeMinimumPledgeRequest")]
    public partial class QuoteProposeMinimumPledgeRequest : IEquatable<QuoteProposeMinimumPledgeRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuoteProposeMinimumPledgeRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QuoteProposeMinimumPledgeRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QuoteProposeMinimumPledgeRequest" /> class.
        /// </summary>
        ...
        public QuoteProposeMinimumPledgeRequest(string amount = default(string), string description = default(string))
        {
            // to ensure "amount" is required (not null)
            if (amount == null) {
                throw new ArgumentNullException("amount is a required property for QuoteProposeMinimumPledgeRequest and cannot be null");
            }
            this.Amount = amount;
            // to ensure "description" is required (not null)
            if (description == null) {
                throw new ArgumentNullException("description is a required property for QuoteProposeMinimumPledgeRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QuoteProposeMinimumPledgeRequest {\n");
        ...
        {
            return this.Equals(input as QuoteProposeMinimumPledgeRequest);
        }

        /// <summary>
        /// Returns true if QuoteProposeMinimumPledgeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of QuoteProposeMinimumPledgeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuoteProposeMinimumPledgeRequest input)
        {
            if (input == null)
            {
                return false;
