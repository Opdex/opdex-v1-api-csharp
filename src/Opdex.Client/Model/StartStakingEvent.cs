...
namespace Opdex.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "startStakingEvent")]
    public partial class StartStakingEvent : IEquatable<StartStakingEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StartStakingEvent" /> class.
        /// </summary>
        ...
        public StartStakingEvent(string staker = default(string), string amount = default(string), string stakerBalance = default(string), string totalStaked = default(string), TransactionEventType eventType = default(TransactionEventType), string contract = default(string), int sortOrder = default(int))
        {
            this.Staker = staker;
            this.Amount = amount;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StartStakingEvent {\n");
        ...
        {
            return this.Equals(input as StartStakingEvent);
        }

        /// <summary>
        /// Returns true if StartStakingEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of StartStakingEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StartStakingEvent input)
        {
            if (input == null)
            {
                return false;
