...
namespace Opdex.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "vaultProposalPledgeEvent")]
    public partial class VaultProposalPledgeEvent : IEquatable<VaultProposalPledgeEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VaultProposalPledgeEvent" /> class.
        /// </summary>
        ...
        /// <param name="totalPledgeMinimumMet">Whether the proposal has met the minimum pledge requirement.</param>
        /// <param name="eventType">eventType.</param>
        /// <param name="contract">An address on the Cirrus network.</param>
        /// <param name="sortOrder">Index to sort event order.</param>
        public VaultProposalPledgeEvent(int proposalId = default(int), string pledger = default(string), string pledgeAmount = default(string), string pledgerAmount = default(string), string proposalPledgeAmount = default(string), bool totalPledgeMinimumMet = default(bool), TransactionEventType eventType = default(TransactionEventType), string contract = default(string), int sortOrder = default(int))
        {
            ...
            this.TotalPledgeMinimumMet = totalPledgeMinimumMet;
        ...
        /// <summary>
        /// Whether the proposal has met the minimum pledge requirement
        /// </summary>
        /// <value>Whether the proposal has met the minimum pledge requirement</value>
        [DataMember(Name = "totalPledgeMinimumMet", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VaultProposalPledgeEvent {\n");
            ...
            sb.Append("  TotalPledgeMinimumMet: ").Append(TotalPledgeMinimumMet).Append("\n");
        ...
        {
            return this.Equals(input as VaultProposalPledgeEvent);
        }

        /// <summary>
        /// Returns true if VaultProposalPledgeEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of VaultProposalPledgeEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VaultProposalPledgeEvent input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.TotalPledgeMinimumMet == input.TotalPledgeMinimumMet ||
                    this.TotalPledgeMinimumMet.Equals(input.TotalPledgeMinimumMet)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.TotalPledgeMinimumMet.GetHashCode();
