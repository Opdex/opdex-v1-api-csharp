...
namespace Opdex.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "collectStakingRewardsEvent")]
    public partial class CollectStakingRewardsEvent : IEquatable<CollectStakingRewardsEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectStakingRewardsEvent" /> class.
        /// </summary>
        ...
        public CollectStakingRewardsEvent(string staker = default(string), string amount = default(string), TransactionEventType eventType = default(TransactionEventType), string contract = default(string), int sortOrder = default(int))
        {
            this.Staker = staker;
            this.Amount = amount;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectStakingRewardsEvent {\n");
        ...
        {
            return this.Equals(input as CollectStakingRewardsEvent);
        }

        /// <summary>
        /// Returns true if CollectStakingRewardsEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectStakingRewardsEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectStakingRewardsEvent input)
        {
            if (input == null)
            {
                return false;
