...
namespace Opdex.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "nominationEvent")]
    public partial class NominationEvent : IEquatable<NominationEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NominationEvent" /> class.
        /// </summary>
        ...
        public NominationEvent(string stakingPool = default(string), string miningPool = default(string), string weight = default(string), TransactionEventType eventType = default(TransactionEventType), string contract = default(string), int sortOrder = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NominationEvent {\n");
        ...
        {
            return this.Equals(input as NominationEvent);
        }

        /// <summary>
        /// Returns true if NominationEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of NominationEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NominationEvent input)
        {
            if (input == null)
            {
                return false;
