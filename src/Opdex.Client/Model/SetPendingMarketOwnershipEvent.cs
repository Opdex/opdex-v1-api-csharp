...
namespace Opdex.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "setPendingMarketOwnershipEvent")]
    public partial class SetPendingMarketOwnershipEvent : IEquatable<SetPendingMarketOwnershipEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetPendingMarketOwnershipEvent" /> class.
        /// </summary>
        ...
        public SetPendingMarketOwnershipEvent(string from = default(string), string to = default(string), TransactionEventType eventType = default(TransactionEventType), string contract = default(string), int sortOrder = default(int))
        {
            this.From = from;
            this.To = to;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SetPendingMarketOwnershipEvent {\n");
        ...
        {
            return this.Equals(input as SetPendingMarketOwnershipEvent);
        }

        /// <summary>
        /// Returns true if SetPendingMarketOwnershipEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of SetPendingMarketOwnershipEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetPendingMarketOwnershipEvent input)
        {
            if (input == null)
            {
                return false;
