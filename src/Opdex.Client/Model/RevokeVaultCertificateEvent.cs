...
namespace Opdex.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "revokeVaultCertificateEvent")]
    public partial class RevokeVaultCertificateEvent : IEquatable<RevokeVaultCertificateEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RevokeVaultCertificateEvent" /> class.
        /// </summary>
        /// <param name="owner">An address on the Cirrus network.</param>
        /// <param name="oldAmount">Decimal value with uncapped precision and size.</param>
        /// <param name="newAmount">Decimal value with uncapped precision and size.</param>
        ...
        public RevokeVaultCertificateEvent(string owner = default(string), string oldAmount = default(string), string newAmount = default(string), int vestedBlock = default(int), TransactionEventType eventType = default(TransactionEventType), string contract = default(string), int sortOrder = default(int))
        {
            this.Owner = owner;
        ...
        [DataMember(Name = "oldAmount", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RevokeVaultCertificateEvent {\n");
        ...
        {
            return this.Equals(input as RevokeVaultCertificateEvent);
        }

        /// <summary>
        /// Returns true if RevokeVaultCertificateEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of RevokeVaultCertificateEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RevokeVaultCertificateEvent input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.OldAmount == input.OldAmount ||
                    (this.OldAmount != null &&
                    this.OldAmount.Equals(input.OldAmount))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.OldAmount.GetHashCode();
                }
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            // OldAmount (string) pattern
            Regex regexOldAmount = new Regex(@"^\\d*\\.\\d{1,18}$", RegexOptions.CultureInvariant);
            if (false == regexOldAmount.Match(this.OldAmount).Success)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for OldAmount, must match a pattern of " + regexOldAmount, new [] { "OldAmount" });
            }

            // NewAmount (string) pattern
            Regex regexNewAmount = new Regex(@"^\\d*\\.\\d{1,18}$", RegexOptions.CultureInvariant);
            if (false == regexNewAmount.Match(this.NewAmount).Success)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NewAmount, must match a pattern of " + regexNewAmount, new [] { "NewAmount" });
            }
