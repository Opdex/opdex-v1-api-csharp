...
namespace Opdex.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "stopStakingEvent")]
    public partial class StopStakingEvent : IEquatable<StopStakingEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StopStakingEvent" /> class.
        /// </summary>
        ...
        /// <param name="stakerBalance">Decimal value with uncapped precision and size.</param>
        /// <param name="totalStaked">Decimal value with uncapped precision and size.</param>
        /// <param name="eventType">eventType.</param>
        /// <param name="contract">An address on the Cirrus network.</param>
        /// <param name="sortOrder">Index to sort event order.</param>
        public StopStakingEvent(string staker = default(string), string amount = default(string), string stakerBalance = default(string), string totalStaked = default(string), TransactionEventType eventType = default(TransactionEventType), string contract = default(string), int sortOrder = default(int))
        {
            this.Staker = staker;
            this.Amount = amount;
            this.StakerBalance = stakerBalance;
        ...
        /// </summary>
        /// <value>Decimal value with uncapped precision and size</value>
        [DataMember(Name = "stakerBalance", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StopStakingEvent {\n");
            sb.Append("  Staker: ").Append(Staker).Append("\n");
            sb.Append("  Amount: ").Append(Amount).Append("\n");
            sb.Append("  StakerBalance: ").Append(StakerBalance).Append("\n");
        ...
        {
            return this.Equals(input as StopStakingEvent);
        }

        /// <summary>
        /// Returns true if StopStakingEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of StopStakingEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StopStakingEvent input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.StakerBalance == input.StakerBalance ||
                    (this.StakerBalance != null &&
                    this.StakerBalance.Equals(input.StakerBalance))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StakerBalance != null)
                {
                    hashCode = (hashCode * 59) + this.StakerBalance.GetHashCode();
                }
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            // StakerBalance (string) pattern
            Regex regexStakerBalance = new Regex(@"^\\d*\\.\\d{1,18}$", RegexOptions.CultureInvariant);
            if (false == regexStakerBalance.Match(this.StakerBalance).Success)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for StakerBalance, must match a pattern of " + regexStakerBalance, new [] { "StakerBalance" });
            }

            // TotalStaked (string) pattern
            Regex regexTotalStaked = new Regex(@"^\\d*\\.\\d{1,18}$", RegexOptions.CultureInvariant);
            if (false == regexTotalStaked.Match(this.TotalStaked).Success)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TotalStaked, must match a pattern of " + regexTotalStaked, new [] { "TotalStaked" });
            }
