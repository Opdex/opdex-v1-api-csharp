...
namespace Opdex.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "swapAmountInQuoteRequest")]
    public partial class SwapAmountInQuoteRequest : IEquatable<SwapAmountInQuoteRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SwapAmountInQuoteRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SwapAmountInQuoteRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SwapAmountInQuoteRequest" /> class.
        /// </summary>
        ...
        public SwapAmountInQuoteRequest(TokenAddress tokenOut = default(TokenAddress), string tokenOutAmount = default(string))
        {
            // to ensure "tokenOut" is required (not null)
            if (tokenOut == null) {
                throw new ArgumentNullException("tokenOut is a required property for SwapAmountInQuoteRequest and cannot be null");
            }
            this.TokenOut = tokenOut;
            // to ensure "tokenOutAmount" is required (not null)
            if (tokenOutAmount == null) {
                throw new ArgumentNullException("tokenOutAmount is a required property for SwapAmountInQuoteRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SwapAmountInQuoteRequest {\n");
        ...
        {
            return this.Equals(input as SwapAmountInQuoteRequest);
        }

        /// <summary>
        /// Returns true if SwapAmountInQuoteRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SwapAmountInQuoteRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwapAmountInQuoteRequest input)
        {
            if (input == null)
            {
                return false;
