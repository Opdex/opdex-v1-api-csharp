...
namespace Opdex.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "startMiningEvent")]
    public partial class StartMiningEvent : IEquatable<StartMiningEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StartMiningEvent" /> class.
        /// </summary>
        ...
        public StartMiningEvent(string staker = default(string), string amount = default(string), string minerBalance = default(string), string totalSupply = default(string), TransactionEventType eventType = default(TransactionEventType), string contract = default(string), int sortOrder = default(int))
        {
            this.Staker = staker;
            this.Amount = amount;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StartMiningEvent {\n");
        ...
        {
            return this.Equals(input as StartMiningEvent);
        }

        /// <summary>
        /// Returns true if StartMiningEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of StartMiningEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StartMiningEvent input)
        {
            if (input == null)
            {
                return false;
