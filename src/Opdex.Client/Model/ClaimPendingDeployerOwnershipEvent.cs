...
namespace Opdex.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "claimPendingDeployerOwnershipEvent")]
    public partial class ClaimPendingDeployerOwnershipEvent : IEquatable<ClaimPendingDeployerOwnershipEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClaimPendingDeployerOwnershipEvent" /> class.
        /// </summary>
        ...
        public ClaimPendingDeployerOwnershipEvent(string from = default(string), string to = default(string), TransactionEventType eventType = default(TransactionEventType), string contract = default(string), int sortOrder = default(int))
        {
            this.From = from;
            this.To = to;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClaimPendingDeployerOwnershipEvent {\n");
        ...
        {
            return this.Equals(input as ClaimPendingDeployerOwnershipEvent);
        }

        /// <summary>
        /// Returns true if ClaimPendingDeployerOwnershipEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of ClaimPendingDeployerOwnershipEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClaimPendingDeployerOwnershipEvent input)
        {
            if (input == null)
            {
                return false;
