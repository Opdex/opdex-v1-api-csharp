...
namespace Opdex.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "approvalEvent")]
    public partial class ApprovalEvent : IEquatable<ApprovalEvent>, IValidatableObject
    {
        /// <summary>
        ...
        public ApprovalEvent(string owner = default(string), string spender = default(string), string amount = default(string), TransactionEventType eventType = default(TransactionEventType), string contract = default(string), int sortOrder = default(int))
        {
            this.Owner = owner;
        ...
        {
            return this.Equals(input as ApprovalEvent);
        }

        /// <summary>
        /// Returns true if ApprovalEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of ApprovalEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApprovalEvent input)
        {
            if (input == null)
            {
                return false;
