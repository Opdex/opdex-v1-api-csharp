...
namespace Opdex.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "claimPendingMarketOwnershipEvent")]
    public partial class ClaimPendingMarketOwnershipEvent : IEquatable<ClaimPendingMarketOwnershipEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClaimPendingMarketOwnershipEvent" /> class.
        /// </summary>
        ...
        public ClaimPendingMarketOwnershipEvent(string from = default(string), string to = default(string), TransactionEventType eventType = default(TransactionEventType), string contract = default(string), int sortOrder = default(int))
        {
            this.From = from;
            this.To = to;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClaimPendingMarketOwnershipEvent {\n");
        ...
        {
            return this.Equals(input as ClaimPendingMarketOwnershipEvent);
        }

        /// <summary>
        /// Returns true if ClaimPendingMarketOwnershipEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of ClaimPendingMarketOwnershipEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClaimPendingMarketOwnershipEvent input)
        {
            if (input == null)
            {
                return false;
